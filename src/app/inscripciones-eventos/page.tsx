...
export default function InscripcionesEventosPage() {
    ...
    const { data: inscripciones, isLoading, refetch } = useCollectionOnce<Inscripcion>(inscripcionesQuery);
