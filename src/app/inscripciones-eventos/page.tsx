...
import { collection, query, orderBy, deleteDoc, doc, getDocs, writeBatch, addDoc, serverTimestamp, setDoc, limit } from 'firebase/firestore';
...
export default function InscripcionesEventosPage() {
    ...
    const canDelete = isAdmin || user?.moduleActions?.['/inscripciones-eventos']?.includes('delete');
